ECHO change paths for your local first!
echo ctrl-c to stop
pause
...
xcopy /c /e/y /d \w4\Sel2inWeb\target\Sel2inWeb\WEB-INF\lib C:\apache-tomcat-7.0.57\lib
...
xcopy /c /e/y /d \w4Sel2inRptWeb\target\Sel2inRptWeb\WEB-INF\lib C:\apache-tomcat-7.0.57\lib
